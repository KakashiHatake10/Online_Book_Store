...
Integer delete = (Integer) request.getAttribute("return");
...
<body>
 ...
 %>
	...
	<%
		if (delete == 1) {
		out.print("<h2 style='text-align:center;'>Return in process .. after complete the amount debit you account..</h2>");
	}
	%>
	<form action="Order_return" method="post">

		<h2></h2>
		<fieldset>
			<legend style="margin-left: 217px; color: blue">
				<h3>Return Order</h3>
			</legend>
